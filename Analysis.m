...
analysisType = 'NADA GFP CT violet hist1 '; % CHANGE THIS FOR EACH DIFFERENT ANALYSIS
...
firstSensorPixel = 1;
lastSensorPixel = 512;
numberOfwavelengthstoPlot = 10; % number of wavelengths to fit beteen 500 and 720nm, evenly spaced
...
lifetimeLow = 0.1; % for stained, 0.7,  1.5 for unstained/fresh, MHorrick 1
